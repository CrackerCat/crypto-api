...
var CryptoApi = function () {
  ...
  function CryptoApi() {
    ...
    this.encoder = {};
    /** @type {fromUtf} */
    this.encoder.fromUtf = _utf.fromUtf;
    /** @type {toHex} */
    this.encoder.toHex = _hex.toHex;
  }
  ...
  _createClass(CryptoApi, [{
    ...
    value: function getHasher(name, options) {
      ...
      switch (name) {
        ...
        case 'md2':
          return new _md2.default(options);
        case 'md4':
          return new _md4.default(options);
        case 'md5':
          return new _md6.default(options);
        case 'ripemd128':
        ...
        case 'sha1':
          return new _sha4.default(options);
        case 'sha224':
          options = Object.assign({}, { length: 224 }, options);
          return new _sha6.default(options);
        case 'sha256':
          options = Object.assign({}, { length: 256 }, options);
          return new _sha6.default(options);
        case 'sha384':
          options = Object.assign({}, { length: 384 }, options);
          return new _sha8.default(options);
        case 'sha512':
    ...
    value: function hash(name, message, options) {
      ...
      hasher.update((0, _utf.fromUtf)(message));
    ...
    value: function getHmac(key, hasher) {
      return new _hmac2.default(key, hasher);
    }
    ...
    value: function hmac(key, message, hasher) {
      var mac = this.getHmac((0, _utf.fromUtf)(key), hasher);
      mac.update((0, _utf.fromUtf)(message));
      return (0, _hex.toHex)(mac.finalize());
    }
  }]);
