...
var _md3 = __webpack_require__(22);

var _md4 = _interopRequireDefault(_md3);

var _md5 = __webpack_require__(9);
...
var _sha3 = __webpack_require__(11);

var _sha4 = _interopRequireDefault(_sha3);

var _sha5 = __webpack_require__(6);

var _sha6 = _interopRequireDefault(_sha5);

var _sha7 = __webpack_require__(7);

var _sha8 = _interopRequireDefault(_sha7);
...
suite('Hash from simple string with HEX result', function (suite) {
  bench('md2', function () {
    suite.md2 = new _md2.default();
    suite.md2.update((0, _utf.fromUtf)('xxx'));
    (0, _hex.toHex)(suite.md2.finalize());
  });
  bench('md4', function () {
    suite.md4 = new _md4.default();
    suite.md4.update((0, _utf.fromUtf)('xxx'));
    (0, _hex.toHex)(suite.md4.finalize());
  });
  bench('md5', function () {
    suite.md5 = new _md6.default();
    suite.md5.update((0, _utf.fromUtf)('xxx'));
    (0, _hex.toHex)(suite.md5.finalize());
  });
  bench('ripemd128', function () {
    suite.ripemd128 = new _ripemd2.default({ length: 128 });
    suite.ripemd128.update((0, _utf.fromUtf)('xxx'));
    (0, _hex.toHex)(suite.ripemd128.finalize());
  });
  bench('ripemd160', function () {
    suite.ripemd160 = new _ripemd2.default({ length: 160 });
    suite.ripemd160.update((0, _utf.fromUtf)('xxx'));
    (0, _hex.toHex)(suite.ripemd160.finalize());
  });
  bench('ripemd256', function () {
    suite.ripemd256 = new _ripemd2.default({ length: 256 });
    suite.ripemd256.update((0, _utf.fromUtf)('xxx'));
    (0, _hex.toHex)(suite.ripemd256.finalize());
  });
  bench('ripemd320', function () {
    suite.ripemd320 = new _ripemd2.default({ length: 320 });
    suite.ripemd320.update((0, _utf.fromUtf)('xxx'));
    (0, _hex.toHex)(suite.ripemd320.finalize());
  });
  bench('has160', function () {
    suite.has160 = new _has2.default();
    suite.has160.update((0, _utf.fromUtf)('xxx'));
    (0, _hex.toHex)(suite.has160.finalize());
  });
  bench('sha0', function () {
    suite.sha0 = new _sha2.default();
    suite.sha0.update((0, _utf.fromUtf)('xxx'));
    (0, _hex.toHex)(suite.sha0.finalize());
  });
  bench('sha1', function () {
    suite.sha1 = new _sha4.default();
    suite.sha1.update((0, _utf.fromUtf)('xxx'));
    (0, _hex.toHex)(suite.sha1.finalize());
  });
  bench('sha224', function () {
    suite.sha224 = new _sha6.default({ length: 224 });
    suite.sha224.update((0, _utf.fromUtf)('xxx'));
    (0, _hex.toHex)(suite.sha224.finalize());
  });
  bench('sha256', function () {
    suite.sha256 = new _sha6.default();
    suite.sha256.update((0, _utf.fromUtf)('xxx'));
    (0, _hex.toHex)(suite.sha256.finalize());
  });
  bench('sha512', function () {
    suite.sha512 = new _sha8.default();
    suite.sha512.update((0, _utf.fromUtf)('xxx'));
    (0, _hex.toHex)(suite.sha512.finalize());
  });
  bench('snefru', function () {
    suite.snefru = new _snefru2.default();
    suite.snefru.update((0, _utf.fromUtf)('xxx'));
    (0, _hex.toHex)(suite.snefru.finalize());
  });
  bench('whirlpool', function () {
    suite.whirlpool = new _whirlpool2.default();
    suite.whirlpool.update((0, _utf.fromUtf)('xxx'));
    (0, _hex.toHex)(suite.whirlpool.finalize());
  });
});
