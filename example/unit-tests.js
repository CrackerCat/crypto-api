...
var TestHasher = function () {
  ...
  _createClass(TestHasher, [{
    ...
    value: function testHash(test) {
      ...
      hash.update((0, _utf.fromUtf)(test.message));
      _chai.assert.equal((0, _hex.toHex)(hash.finalize()), test.hash);
    }
    ...
    value: function testSetGetState(options) {
      ...
      hasher.update('1');
      var hash1 = (0, _hex.toHex)(hasher.finalize());
      hasher.reset();
      hasher.update('12');
      var hash2 = (0, _hex.toHex)(hasher.finalize());
      hasher.reset();
      hasher.update('1');
      var state = hasher.getState();
      _chai.assert.equal((0, _hex.toHex)(hasher.finalize()), hash1);
      hasher.setState(state);
      hasher.update('2');
      _chai.assert.equal((0, _hex.toHex)(hasher.finalize()), hash2);
    }
    ...
    value: function getInstance(options) {
      return new _hasher2.default(options);
    }
  }]);
...
var Ripemd = function (_Hasher32le) {
  ...
  function Ripemd(options) {
    ...
    var _this = _possibleConstructorReturn(this, (Ripemd.__proto__ || Object.getPrototypeOf(Ripemd)).call(this, options));

    _this.options.length = _this.options.length || 160;
    switch (_this.options.length) {
      case 128:
        _this.state.hash = [0x67452301, 0xefcdab89, 0x98badcfe, 0x10325476];
        /**
         ...
         * @param {number[]} block - Block
         */
        _this.processBlock = _this.processBlock128;
        break;
      case 256:
        _this.state.hash = [0x67452301, 0xefcdab89, 0x98badcfe, 0x10325476, 0x76543210, 0xfedcba98, 0x89abcdef, 0x01234567];
        _this.processBlock = _this.processBlock256;
        break;
      case 320:
        _this.state.hash = [0x67452301, 0xefcdab89, 0x98badcfe, 0x10325476, 0xc3d2e1f0, 0x76543210, 0xfedcba98, 0x89abcdef, 0x01234567, 0x3c2d1e0f];
        _this.processBlock = _this.processBlock320;
        break;
      default:
        // 160
        _this.state.hash = [0x67452301, 0xefcdab89, 0x98badcfe, 0x10325476, 0xc3d2e1f0];
        _this.processBlock = _this.processBlock160;
    }
    return _this;
  }
...
var Snefru = function (_Hasher32be) {
  ...
  function Snefru(options) {
    ...
    var _this = _possibleConstructorReturn(this, (Snefru.__proto__ || Object.getPrototypeOf(Snefru)).call(this, options));

    _this.options.length = _this.options.length || 128;
    _this.options.rounds = _this.options.rounds || 8;

    _this.state.hash = new Array(_this.options.length / 32 | 0);
    for (var i = 0; i < _this.state.hash.length; i++) {
      _this.state.hash[i] = 0 | 0;
    }
      ...
      for (var _i2 = 0; _i2 < this.options.rounds << 1; _i2 += 2) {
        for (var byteInWord = 0; byteInWord < 4; byteInWord++) {
          ...
          for (var _n = 0; _n < 16; _n++) {
            this.W[_n] = (0, _tools.rotateRight)(this.W[_n], shiftTable[byteInWord]);
          }
        }
      }
...
function calculateRC(SBOX, theta) {
  ...
  for (var i = 0; i < 256; i++) {
    ...
    for (var _t = 1; _t < 8; _t++) {
      C[_t][i * 2] = (0, _tools.rotateRight64lo)(C[0][i * 2 + 1], C[0][i * 2], _t << 3);
      C[_t][i * 2 + 1] = (0, _tools.rotateRight64hi)(C[0][i * 2 + 1], C[0][i * 2], _t << 3);
    }
  }
...
var Whirlpool = function (_Hasher32be) {
  ...
  function Whirlpool(options) {
    ...
    var _this = _possibleConstructorReturn(this, (Whirlpool.__proto__ || Object.getPrototypeOf(Whirlpool)).call(this, options));

    _this.options.type = _this.options.type || '';
    _this.options.rounds = _this.options.rounds || 10;

    _this.state.hash = new Array(16);
    for (var i = 0; i < 16; i++) {
      _this.state.hash[i] = 0;
    }
...
var _hmac = __webpack_require__(28);
...
var TestHmac = function () {
  function TestHmac() {
    _classCallCheck(this, TestHmac);
  }

  _createClass(TestHmac, [{
    key: "testHmac",
    ...
    value: function testHmac(test) {
      var hash = this.getInstance(test.options || {});
      var hmac = new _hmac2.default(test.key, hash);
      hmac.update(test.message);
      _chai.assert.equal((0, _hex.toHex)(hmac.finalize()), test.hash);
    }
...
var Has160 = function (_Hasher32le) {
  ...
  function Has160(options) {
     ...
     */
    var _this = _possibleConstructorReturn(this, (Has160.__proto__ || Object.getPrototypeOf(Has160)).call(this, options));
  ...
  _createClass(Has160, [{
    ...
    value: function processBlock(block) {
      ...
      // Calculate hash
      for (var _i = 0; _i < this.options.rounds; _i++) {
        var t = (0, _tools.rotateLeft)(a, ROT[_i % 20]) + e + this.W[IND[_i]] + K[_i / 20 >> 0] | 0;
        if (_i < 20) {
          t = t + (b & c | ~b & d) | 0;
        } else if (_i < 40) {
          t = t + (b ^ c ^ d) | 0;
        ...
        e = d;
        d = c;
        c = (0, _tools.rotateLeft)(b, ROT2[_i / 20 >> 0]) | 0;
        b = a;
        a = t;
      }
...
var Md4 = function (_Hasher32le) {
   ...
   * @param {Object} [options]
   */
  function Md4(options) {
    _classCallCheck(this, Md4);

    var _this = _possibleConstructorReturn(this, (Md4.__proto__ || Object.getPrototypeOf(Md4)).call(this, options));
  ...
  _createClass(Md4, [{
    ...
    key: "CC",
    value: function CC(f, k, a, x, y, z, m, s) {
      return (0, _tools.rotateLeft)(a + f(x, y, z) + m + k, s) | 0;
    }
  }]);
...
var Sha0 = function (_Hasher32be) {
  ...
  function Sha0(options) {
    ...
    var _this = _possibleConstructorReturn(this, (Sha0.__proto__ || Object.getPrototypeOf(Sha0)).call(this, options));
...
var _has160Test = __webpack_require__(44);

var _has160Test2 = _interopRequireDefault(_has160Test);

var _md2Test = __webpack_require__(68);

var _md2Test2 = _interopRequireDefault(_md2Test);

var _md4Test = __webpack_require__(69);

var _md4Test2 = _interopRequireDefault(_md4Test);

var _md5Test = __webpack_require__(70);

var _md5Test2 = _interopRequireDefault(_md5Test);

var _ripemd128Test = __webpack_require__(71);

var _ripemd128Test2 = _interopRequireDefault(_ripemd128Test);

var _ripemd160Test = __webpack_require__(72);

var _ripemd160Test2 = _interopRequireDefault(_ripemd160Test);

var _ripemd256Test = __webpack_require__(73);

var _ripemd256Test2 = _interopRequireDefault(_ripemd256Test);

var _ripemd320Test = __webpack_require__(74);

var _ripemd320Test2 = _interopRequireDefault(_ripemd320Test);

var _sha0Test = __webpack_require__(75);

var _sha0Test2 = _interopRequireDefault(_sha0Test);

var _sha1Test = __webpack_require__(76);

var _sha1Test2 = _interopRequireDefault(_sha1Test);

var _sha224Test = __webpack_require__(77);

var _sha224Test2 = _interopRequireDefault(_sha224Test);

var _sha256Test = __webpack_require__(78);

var _sha256Test2 = _interopRequireDefault(_sha256Test);

var _sha384Test = __webpack_require__(79);

var _sha384Test2 = _interopRequireDefault(_sha384Test);

var _sha512_224Test = __webpack_require__(80);

var _sha512_224Test2 = _interopRequireDefault(_sha512_224Test);

var _sha512_256Test = __webpack_require__(81);

var _sha512_256Test2 = _interopRequireDefault(_sha512_256Test);

var _sha512Test = __webpack_require__(82);

var _sha512Test2 = _interopRequireDefault(_sha512Test);

var _snefru128_2Test = __webpack_require__(83);

var _snefru128_2Test2 = _interopRequireDefault(_snefru128_2Test);

var _snefru128_8Test = __webpack_require__(84);

var _snefru128_8Test2 = _interopRequireDefault(_snefru128_8Test);

var _snefru256_4Test = __webpack_require__(85);

var _snefru256_4Test2 = _interopRequireDefault(_snefru256_4Test);

var _snefru256_8Test = __webpack_require__(86);

var _snefru256_8Test2 = _interopRequireDefault(_snefru256_8Test);

var _whirlpool0Test = __webpack_require__(87);

var _whirlpool0Test2 = _interopRequireDefault(_whirlpool0Test);

var _whirlpoolTTest = __webpack_require__(88);

var _whirlpoolTTest2 = _interopRequireDefault(_whirlpoolTTest);

var _whirlpoolTest = __webpack_require__(89);

var _whirlpoolTest2 = _interopRequireDefault(_whirlpoolTest);

var _hmacHas160Test = __webpack_require__(90);

var _hmacHas160Test2 = _interopRequireDefault(_hmacHas160Test);

var _hmacMd5Test = __webpack_require__(91);

var _hmacMd5Test2 = _interopRequireDefault(_hmacMd5Test);

var _hmacSha1Test = __webpack_require__(92);

var _hmacSha1Test2 = _interopRequireDefault(_hmacSha1Test);

var _hmacSha224Test = __webpack_require__(93);

var _hmacSha224Test2 = _interopRequireDefault(_hmacSha224Test);

var _hmacSha256Test = __webpack_require__(94);

var _hmacSha256Test2 = _interopRequireDefault(_hmacSha256Test);

var _hmacSha384Test = __webpack_require__(95);

var _hmacSha384Test2 = _interopRequireDefault(_hmacSha384Test);

var _hmacSha512Test = __webpack_require__(96);

var _hmacSha512Test2 = _interopRequireDefault(_hmacSha512Test);

var _UtfTest = __webpack_require__(97);

var _UtfTest2 = _interopRequireDefault(_UtfTest);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// Hash tests
new _has160Test2.default().test();
new _md2Test2.default().test();
new _md4Test2.default().test();
new _md5Test2.default().test();
new _ripemd128Test2.default().test();
new _ripemd160Test2.default().test();
new _ripemd256Test2.default().test();
new _ripemd320Test2.default().test();
new _sha0Test2.default().test();
new _sha1Test2.default().test();
new _sha224Test2.default().test();
new _sha256Test2.default().test();
new _sha384Test2.default().test();
new _sha512_224Test2.default().test();
new _sha512_256Test2.default().test();
new _sha512Test2.default().test();
new _snefru128_2Test2.default().test();
new _snefru128_8Test2.default().test();
new _snefru256_4Test2.default().test();
new _snefru256_8Test2.default().test();
new _whirlpool0Test2.default().test();
new _whirlpoolTTest2.default().test();
new _whirlpoolTest2.default().test();

// HMAC tests
new _hmacHas160Test2.default().test();
new _hmacMd5Test2.default().test();
new _hmacSha1Test2.default().test();
new _hmacSha224Test2.default().test();
new _hmacSha256Test2.default().test();
new _hmacSha384Test2.default().test();
new _hmacSha512Test2.default().test();

// UTF tests
new _UtfTest2.default().test();
...
var _TestHasher2 = __webpack_require__(2);

var _TestHasher3 = _interopRequireDefault(_TestHasher2);
 ...
 */
var Has160Test = function (_TestHasher) {
  _inherits(Has160Test, _TestHasher);

  function Has160Test() {
    _classCallCheck(this, Has160Test);

    return _possibleConstructorReturn(this, (Has160Test.__proto__ || Object.getPrototypeOf(Has160Test)).apply(this, arguments));
  }

  _createClass(Has160Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /** @test {Has160} */
    ...
    key: "getInstance",
    value: function getInstance(options) {
      return new _has2.default(options || {});
    }
  }]);

  return Has160Test;
}(_TestHasher3.default);

exports.default = Has160Test;
 ...
 */
var Md2Test = function (_TestHasher) {
  _inherits(Md2Test, _TestHasher);

  function Md2Test() {
    _classCallCheck(this, Md2Test);

    return _possibleConstructorReturn(this, (Md2Test.__proto__ || Object.getPrototypeOf(Md2Test)).apply(this, arguments));
  }

  _createClass(Md2Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /** @test {Md2} */
...
var Md4Test = function (_TestHasher) {
  _inherits(Md4Test, _TestHasher);

  function Md4Test() {
    _classCallCheck(this, Md4Test);

    return _possibleConstructorReturn(this, (Md4Test.__proto__ || Object.getPrototypeOf(Md4Test)).apply(this, arguments));
  }

  _createClass(Md4Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /** @test {Md4} */
...
var Md5Test = function (_TestHasher) {
  _inherits(Md5Test, _TestHasher);

  function Md5Test() {
    _classCallCheck(this, Md5Test);

    return _possibleConstructorReturn(this, (Md5Test.__proto__ || Object.getPrototypeOf(Md5Test)).apply(this, arguments));
  }

  _createClass(Md5Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /** @test {Md5} */
...
var _ripemd = __webpack_require__(10);
...
var Ripemd128Test = function (_TestHasher) {
  _inherits(Ripemd128Test, _TestHasher);

  function Ripemd128Test() {
    _classCallCheck(this, Ripemd128Test);

    return _possibleConstructorReturn(this, (Ripemd128Test.__proto__ || Object.getPrototypeOf(Ripemd128Test)).apply(this, arguments));
  }

  _createClass(Ripemd128Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /** @test {Ripemd} */
    ...
    key: "getInstance",
    value: function getInstance(options) {
      return new _ripemd2.default(options || { length: 128 });
    }
  }]);
...
var Ripemd160Test = function (_TestHasher) {
  _inherits(Ripemd160Test, _TestHasher);

  function Ripemd160Test() {
    _classCallCheck(this, Ripemd160Test);

    return _possibleConstructorReturn(this, (Ripemd160Test.__proto__ || Object.getPrototypeOf(Ripemd160Test)).apply(this, arguments));
  }

  _createClass(Ripemd160Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /** @test {Ripemd} */
    ...
    key: "getInstance",
    value: function getInstance(options) {
      return new _ripemd2.default(options);
    }
  }]);
...
var Ripemd256Test = function (_TestHasher) {
  _inherits(Ripemd256Test, _TestHasher);

  function Ripemd256Test() {
    _classCallCheck(this, Ripemd256Test);

    return _possibleConstructorReturn(this, (Ripemd256Test.__proto__ || Object.getPrototypeOf(Ripemd256Test)).apply(this, arguments));
  }

  _createClass(Ripemd256Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /** @test {Ripemd} */
    ...
    key: "getInstance",
    value: function getInstance(options) {
      return new _ripemd2.default(options || { length: 256 });
    }
  }]);
...
var Ripemd320Test = function (_TestHasher) {
  _inherits(Ripemd320Test, _TestHasher);

  function Ripemd320Test() {
    _classCallCheck(this, Ripemd320Test);

    return _possibleConstructorReturn(this, (Ripemd320Test.__proto__ || Object.getPrototypeOf(Ripemd320Test)).apply(this, arguments));
  }

  _createClass(Ripemd320Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /** @test {Ripemd} */
    ...
    key: "getInstance",
    value: function getInstance(options) {
      return new _ripemd2.default(options || { length: 320 });
    }
  }]);
...
var Sha0Test = function (_TestHasher) {
  _inherits(Sha0Test, _TestHasher);

  function Sha0Test() {
    _classCallCheck(this, Sha0Test);

    return _possibleConstructorReturn(this, (Sha0Test.__proto__ || Object.getPrototypeOf(Sha0Test)).apply(this, arguments));
  }

  _createClass(Sha0Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /** @test {Sha0} */
...
var Sha1Test = function (_TestHasher) {
  _inherits(Sha1Test, _TestHasher);

  function Sha1Test() {
    _classCallCheck(this, Sha1Test);

    return _possibleConstructorReturn(this, (Sha1Test.__proto__ || Object.getPrototypeOf(Sha1Test)).apply(this, arguments));
  }

  _createClass(Sha1Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /** @test {Sha1} */
...
var Sha224Test = function (_TestHasher) {
  _inherits(Sha224Test, _TestHasher);

  function Sha224Test() {
    _classCallCheck(this, Sha224Test);

    return _possibleConstructorReturn(this, (Sha224Test.__proto__ || Object.getPrototypeOf(Sha224Test)).apply(this, arguments));
  }

  _createClass(Sha224Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /** @test {Sha256} */
    ...
    key: "getInstance",
    value: function getInstance(options) {
      return new _sha2.default(options || { length: 224 });
    }
  }]);
...
var Sha256Test = function (_TestHasher) {
  _inherits(Sha256Test, _TestHasher);

  function Sha256Test() {
    _classCallCheck(this, Sha256Test);

    return _possibleConstructorReturn(this, (Sha256Test.__proto__ || Object.getPrototypeOf(Sha256Test)).apply(this, arguments));
  }

  _createClass(Sha256Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /** @test {Sha256} */
    ...
    key: "getInstance",
    value: function getInstance(options) {
      return new _sha2.default(options);
    }
  }]);
...
var _sha = __webpack_require__(7);
...
var Sha384Test = function (_TestHasher) {
  _inherits(Sha384Test, _TestHasher);

  function Sha384Test() {
    _classCallCheck(this, Sha384Test);

    return _possibleConstructorReturn(this, (Sha384Test.__proto__ || Object.getPrototypeOf(Sha384Test)).apply(this, arguments));
  }

  _createClass(Sha384Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /** @test {Sha512} */
    ...
    key: "getInstance",
    value: function getInstance(options) {
      return new _sha2.default(options || { length: 384 });
    }
  }]);
...
var Sha512_224Test = function (_TestHasher) {
  _inherits(Sha512_224Test, _TestHasher);

  function Sha512_224Test() {
    _classCallCheck(this, Sha512_224Test);

    return _possibleConstructorReturn(this, (Sha512_224Test.__proto__ || Object.getPrototypeOf(Sha512_224Test)).apply(this, arguments));
  }

  _createClass(Sha512_224Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /** @test {Sha512} */
...
exports.default = Sha512_224Test;
...
var Sha512_256Test = function (_TestHasher) {
  _inherits(Sha512_256Test, _TestHasher);

  function Sha512_256Test() {
    _classCallCheck(this, Sha512_256Test);

    return _possibleConstructorReturn(this, (Sha512_256Test.__proto__ || Object.getPrototypeOf(Sha512_256Test)).apply(this, arguments));
  }

  _createClass(Sha512_256Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /** @test {Sha512} */
    ...
    key: "getInstance",
    value: function getInstance(options) {
      return new _sha2.default(options || { length: 256 });
    }
  }]);
...
exports.default = Sha512_256Test;
...
var Sha512Test = function (_TestHasher) {
  _inherits(Sha512Test, _TestHasher);

  function Sha512Test() {
    _classCallCheck(this, Sha512Test);

    return _possibleConstructorReturn(this, (Sha512Test.__proto__ || Object.getPrototypeOf(Sha512Test)).apply(this, arguments));
  }

  _createClass(Sha512Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /** @test {Sha512} */
...
var _snefru = __webpack_require__(12);

var _snefru2 = _interopRequireDefault(_snefru);
...
var Snefru128_2Test = function (_TestHasher) {
  _inherits(Snefru128_2Test, _TestHasher);

  function Snefru128_2Test() {
    _classCallCheck(this, Snefru128_2Test);

    return _possibleConstructorReturn(this, (Snefru128_2Test.__proto__ || Object.getPrototypeOf(Snefru128_2Test)).apply(this, arguments));
  }

  _createClass(Snefru128_2Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /** @test {Snefru} */
    ...
    key: "getInstance",
    value: function getInstance(options) {
      return new _snefru2.default(options || { rounds: 2 });
    }
  }]);
...
exports.default = Snefru128_2Test;
...
var Snefru128_8Test = function (_TestHasher) {
  _inherits(Snefru128_8Test, _TestHasher);

  function Snefru128_8Test() {
    _classCallCheck(this, Snefru128_8Test);

    return _possibleConstructorReturn(this, (Snefru128_8Test.__proto__ || Object.getPrototypeOf(Snefru128_8Test)).apply(this, arguments));
  }

  _createClass(Snefru128_8Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /** @test {Snefru} */
    ...
    key: "getInstance",
    value: function getInstance(options) {
      return new _snefru2.default(options);
    }
  }]);
...
exports.default = Snefru128_8Test;
...
var Snefru256_4Test = function (_TestHasher) {
  _inherits(Snefru256_4Test, _TestHasher);

  function Snefru256_4Test() {
    _classCallCheck(this, Snefru256_4Test);

    return _possibleConstructorReturn(this, (Snefru256_4Test.__proto__ || Object.getPrototypeOf(Snefru256_4Test)).apply(this, arguments));
  }

  _createClass(Snefru256_4Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /** @test {Snefru} */
    ...
    key: "getInstance",
    value: function getInstance(options) {
      return new _snefru2.default(options || { length: 256, rounds: 4 });
    }
  }]);
...
exports.default = Snefru256_4Test;
...
var Snefru256_8Test = function (_TestHasher) {
  _inherits(Snefru256_8Test, _TestHasher);

  function Snefru256_8Test() {
    _classCallCheck(this, Snefru256_8Test);

    return _possibleConstructorReturn(this, (Snefru256_8Test.__proto__ || Object.getPrototypeOf(Snefru256_8Test)).apply(this, arguments));
  }

  _createClass(Snefru256_8Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /** @test {Snefru} */
    ...
    key: "getInstance",
    value: function getInstance(options) {
      return new _snefru2.default(options || { length: 256 });
    }
  }]);
...
exports.default = Snefru256_8Test;
...
var _whirlpool = __webpack_require__(16);

var _whirlpool2 = _interopRequireDefault(_whirlpool);
...
var Whirlpool0Test = function (_TestHasher) {
  _inherits(Whirlpool0Test, _TestHasher);

  function Whirlpool0Test() {
    _classCallCheck(this, Whirlpool0Test);

    return _possibleConstructorReturn(this, (Whirlpool0Test.__proto__ || Object.getPrototypeOf(Whirlpool0Test)).apply(this, arguments));
  }

  _createClass(Whirlpool0Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /** @test {Whirlpool} */
    ...
    key: "getInstance",
    value: function getInstance(options) {
      return new _whirlpool2.default(options || { type: '0' });
    }
  }]);
...
exports.default = Whirlpool0Test;
...
var WhirlpoolTTest = function (_TestHasher) {
  _inherits(WhirlpoolTTest, _TestHasher);

  function WhirlpoolTTest() {
    _classCallCheck(this, WhirlpoolTTest);

    return _possibleConstructorReturn(this, (WhirlpoolTTest.__proto__ || Object.getPrototypeOf(WhirlpoolTTest)).apply(this, arguments));
  }

  _createClass(WhirlpoolTTest, [{
    key: "test",
    value: function test() {
      var t = this;
      /** @test {Whirlpool} */
    ...
    key: "getInstance",
    value: function getInstance(options) {
      return new _whirlpool2.default(options || { type: 't' });
    }
  }]);
...
exports.default = WhirlpoolTTest;
...
var WhirlpoolTest = function (_TestHasher) {
  _inherits(WhirlpoolTest, _TestHasher);

  function WhirlpoolTest() {
    _classCallCheck(this, WhirlpoolTest);

    return _possibleConstructorReturn(this, (WhirlpoolTest.__proto__ || Object.getPrototypeOf(WhirlpoolTest)).apply(this, arguments));
  }

  _createClass(WhirlpoolTest, [{
    key: "test",
    value: function test() {
      var t = this;
      /** @test {Whirlpool} */
    ...
    key: "getInstance",
    value: function getInstance(options) {
      return new _whirlpool2.default(options);
    }
  }]);
...
var _TestHmac2 = __webpack_require__(20);

var _TestHmac3 = _interopRequireDefault(_TestHmac2);
...
var HmacHas160Test = function (_TestHmac) {
  _inherits(HmacHas160Test, _TestHmac);

  function HmacHas160Test() {
    _classCallCheck(this, HmacHas160Test);

    return _possibleConstructorReturn(this, (HmacHas160Test.__proto__ || Object.getPrototypeOf(HmacHas160Test)).apply(this, arguments));
  }

  _createClass(HmacHas160Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /**
...
exports.default = HmacHas160Test;
...
var HmacMd5Test = function (_TestHmac) {
  _inherits(HmacMd5Test, _TestHmac);

  function HmacMd5Test() {
    _classCallCheck(this, HmacMd5Test);

    return _possibleConstructorReturn(this, (HmacMd5Test.__proto__ || Object.getPrototypeOf(HmacMd5Test)).apply(this, arguments));
  }

  _createClass(HmacMd5Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /**
...
var HmacSha1Test = function (_TestHmac) {
  _inherits(HmacSha1Test, _TestHmac);

  function HmacSha1Test() {
    _classCallCheck(this, HmacSha1Test);

    return _possibleConstructorReturn(this, (HmacSha1Test.__proto__ || Object.getPrototypeOf(HmacSha1Test)).apply(this, arguments));
  }

  _createClass(HmacSha1Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /**
...
var HmacSha224Test = function (_TestHmac) {
  _inherits(HmacSha224Test, _TestHmac);

  function HmacSha224Test() {
    _classCallCheck(this, HmacSha224Test);

    return _possibleConstructorReturn(this, (HmacSha224Test.__proto__ || Object.getPrototypeOf(HmacSha224Test)).apply(this, arguments));
  }

  _createClass(HmacSha224Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /**
    ...
    key: "getInstance",
    value: function getInstance(options) {
      return new _sha2.default({ length: 224 });
    }
  }]);
...
exports.default = HmacSha224Test;
...
var HmacSha256Test = function (_TestHmac) {
  _inherits(HmacSha256Test, _TestHmac);

  function HmacSha256Test() {
    _classCallCheck(this, HmacSha256Test);

    return _possibleConstructorReturn(this, (HmacSha256Test.__proto__ || Object.getPrototypeOf(HmacSha256Test)).apply(this, arguments));
  }

  _createClass(HmacSha256Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /**
...
exports.default = HmacSha256Test;
...
var HmacSha384Test = function (_TestHmac) {
  _inherits(HmacSha384Test, _TestHmac);

  function HmacSha384Test() {
    _classCallCheck(this, HmacSha384Test);

    return _possibleConstructorReturn(this, (HmacSha384Test.__proto__ || Object.getPrototypeOf(HmacSha384Test)).apply(this, arguments));
  }

  _createClass(HmacSha384Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /**
    ...
    key: "getInstance",
    value: function getInstance(options) {
      return new _sha2.default({ length: 384 });
    }
  }]);
...
exports.default = HmacSha384Test;
...
var HmacSha512Test = function (_TestHmac) {
  _inherits(HmacSha512Test, _TestHmac);

  function HmacSha512Test() {
    _classCallCheck(this, HmacSha512Test);

    return _possibleConstructorReturn(this, (HmacSha512Test.__proto__ || Object.getPrototypeOf(HmacSha512Test)).apply(this, arguments));
  }

  _createClass(HmacSha512Test, [{
    key: "test",
    value: function test() {
      var t = this;
      /**
...
exports.default = HmacSha512Test;
...
var UtfTest = function () {
  function UtfTest() {
    _classCallCheck(this, UtfTest);
  }

  _createClass(UtfTest, [{
    key: "test",
    value: function test() {
      /** @test fromUtf */
      describe('Encoder UTF tests', function () {
        ...
        it("fromUtf('\\0')", function () {
          _chai.assert.equal((0, _hex.toHex)((0, _utf.fromUtf)('\0')), '00');
        });

        /** @test fromUtf */
        it("fromUtf('\\x5c')", function () {
          _chai.assert.equal((0, _hex.toHex)((0, _utf.fromUtf)('\x5c')), '5c');
        });

        /** @test fromUtf */
        it("fromUtf('\\x7f')", function () {
          _chai.assert.equal((0, _hex.toHex)((0, _utf.fromUtf)('\x7f')), '7f');
        });

        /** @test fromUtf */
        it("fromUtf('\\x80')", function () {
          _chai.assert.equal((0, _hex.toHex)((0, _utf.fromUtf)('\x80')), 'c280');
        });

        /** @test fromUtf */
        it("fromUtf('\\u05ca')", function () {
          _chai.assert.equal((0, _hex.toHex)((0, _utf.fromUtf)("\u05CA")), 'd78a');
        });

        /** @test fromUtf */
        it("fromUtf('\\u07ff')", function () {
          _chai.assert.equal((0, _hex.toHex)((0, _utf.fromUtf)("\u07FF")), 'dfbf');
        });

        /** @test fromUtf */
        it("fromUtf('\\u0800')", function () {
          _chai.assert.equal((0, _hex.toHex)((0, _utf.fromUtf)("\u0800")), 'e0a080');
        });

        /** @test fromUtf */
        it("fromUtf('\\u2c3c')", function () {
          _chai.assert.equal((0, _hex.toHex)((0, _utf.fromUtf)("\u2C3C")), 'e2b0bc');
        });

        /** @test fromUtf */
        it("fromUtf('\\uffff')", function () {
          _chai.assert.equal((0, _hex.toHex)((0, _utf.fromUtf)("\uFFFF")), 'efbfbf');
        });

        /** @test fromUtf */
        it("fromUtf('\\ud800\\udc00')", function () {
          _chai.assert.equal((0, _hex.toHex)((0, _utf.fromUtf)("\uD800\uDC00")), 'f0908080');
        });

        /** @test fromUtf */
        it("fromUtf('\\ud834\\udf06')", function () {
          _chai.assert.equal((0, _hex.toHex)((0, _utf.fromUtf)("\uD834\uDF06")), 'f09d8c86');
        });

        /** @test fromUtf */
        it("fromUtf('\\udbff\\udfff')", function () {
          _chai.assert.equal((0, _hex.toHex)((0, _utf.fromUtf)("\uDBFF\uDFFF")), 'f48fbfbf');
        });
      });
    }
  }]);
